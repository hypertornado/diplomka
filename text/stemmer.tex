...
Pro angličtinu je nejznámějším stemmerem pro angličtinu je Porterův stemmer\cite{porter80} popsaný Martinem Porterem již v roce 1980. Kromě oficiální implementace existují porty do různých jazyků včetně Ruby. Aplikace využívá implementaci z Ruby Gemu \uv{stemmify}\footnote{\url{https://rubygems.org/gems/stemmify}} v licenci MIT.
