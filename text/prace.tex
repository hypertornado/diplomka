...
\include{preklad}
\include{stemmer}
\include{detekce_jazyka}
\include{similar}
%\include{kap2}
\include{backend}
\include{frontend}
\include{zprovozneni}
\include{anotacni_rozhrani}
\include{evaluace}
