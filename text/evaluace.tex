...
Během anotace se zjistilo, že u dvou testovacích sad se jeden z obrázků nenačítá. Tyto sady byly z testování vyřazeny a anotovaných testovacích sad je tedy pouze 58. Výsledky testování jsou shrnuty v tabulce \ref{tab:testresults} ve sloupci \uv{o\_test1}. Pobrobné výsledky testování, včetně Cohenovy kappy pro všechny dvojice anotátorů je v příloze \ref{app:testing}.
